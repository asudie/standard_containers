...
TEST(s21_map_insert_check, test1) {
  s21::Map<int, int> st;
  std::map<int, int> st_original;
  std::pair<s21::Map<int, int>::Iterator, bool> it =
...
TEST(s21_map_insert_check, test2) {
  s21::Map<int, int> t;
  ...
  s21::Map<int, int>::iterator it = t.begin();
...
TEST(s21_map_insert_check, test3) {
  s21::Map<int, int> st;
  std::map<int, int> st_original;
  std::pair<s21::Map<int, int>::Iterator, bool> it =
      st.insert(std::pair<int, int>(1, 111));
...
TEST(s21_map_insert_check, test4) {
  s21::Map<int, int> st;
  std::map<int, int> st_original;
  std::pair<s21::Map<int, int>::Iterator, bool> it = st.insert(1, 111);
  std::pair<std::map<int, int>::iterator, bool> it_original =
      st_original.insert(std::pair<int, int>(1, 111));
  ASSERT_EQ(it.first->first, it_original.first->first);
  ASSERT_EQ(it.first->second, it_original.first->second);
...
TEST(s21_map_contains_check, test1) {
  s21::Map<int, int> st;
  st.insert(std::pair<int, int>(1, 111));
...
TEST(s21_map_empty_check, test1) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
...
TEST(s21_map_initializer_check, test1) {
  s21::Map<int, char> t(
...
TEST(s21_map_clear_check, test1) {
  s21::Map<int, char> t(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
  std::map<int, char> t_original(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
...
TEST(s21_map_copy_check, test1) {
  s21::Map<int, char> t(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
  std::map<int, char> t_original(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
  s21::Map<int, char> t_1(t);
...
TEST(s21_map_oper_copy_check, test1) {
  s21::Map<int, char> t(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
  std::map<int, char> t_original(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
  s21::Map<int, char> t_1;
  t_1 = t;
...
TEST(s21_map_begin_check, test1) {
  s21::Map<int, char> t(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
  std::map<int, char> t_original(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
  s21::Map<int, char>::iterator it = t.begin();
  std::map<int, char>::iterator it_original = t_original.begin();
  ASSERT_EQ(it->first, it_original->first);
  ASSERT_EQ(it->second, it_original->second);
}

TEST(s21_map_incpref_iter_check, test1) {
  s21::Map<int, char> t(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
  std::map<int, char> t_original(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
...
TEST(s21_map_incpref_iter_check, test2) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  for (int i = -27; i < 36; ++i) {
...
TEST(s21_map_incpref_iter_check, test3) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  for (int i = -27; i < 36; ++i) {
    t.insert(std::pair<int, int>(i, 111));
...
TEST(s21_map_incpref_iter_check, test4) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
...
TEST(s21_map_iter_incpost_check, test1) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  for (int i = -27; i < 136; i += 3) {
    t.insert(std::pair<int, int>(i, 111));
...
TEST(s21_map_decpref_iter_check, test1) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  for (int i = -27; i < 36; ++i) {
    t.insert(std::pair<int, int>(i, 111));
  ...
  s21::Map<int, int>::iterator it = t.end();
...
TEST(s21_map_decpref_iter_check, test2) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  for (int i = -27; i < 36; ++i) {
    t.insert(std::pair<int, int>(i, 111));
...
TEST(s21_map_decpref_iter_check, test3) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  for (int i = -27; i < 36; ++i) {
    t.insert(std::pair<int, int>(i, 111));
...
TEST(s21_map_iter_decpost_check, test1) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  for (int i = -27; i < 136; i += 3) {
    t.insert(std::pair<int, int>(i, 111));
...
TEST(s21_map_decpost_iter_check, test2) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  for (int i = -27; i < 36; ++i) {
    t.insert(std::pair<int, int>(i, 111));
...
TEST(s21_map_insert_string_check, test1) {
  s21::Map<std::string, int> t;
  ...
  s21::Map<std::string, int>::Iterator it = t.begin();
...
TEST(s21_map_erase_check, test1) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(1, 111));
...
TEST(s21_map_erase_check, test2) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(1, 111));
...
TEST(s21_map_erase_check, test3) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(1, 111));
...
TEST(s21_map_erase_check, test4) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(1, 111));
...
TEST(s21_map_erase_check, test5) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(1, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test6) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(3, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test7) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(1, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test8) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(3, 111));
  t_original.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test9) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(3, 111));
  t.insert(std::pair<int, int>(1, 111));
...
TEST(s21_map_erase_check, test10) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(1, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test11) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(1, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test12) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(5, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test13) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test14) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test15) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test16) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test17) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test18) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test19) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test20) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test21) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test22) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(8, 111));
  t.insert(std::pair<int, int>(7, 111));
...
TEST(s21_map_erase_check, test23) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(8, 111));
  t.insert(std::pair<int, int>(7, 111));
...
TEST(s21_map_erase_check, test24) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(8, 111));
  t.insert(std::pair<int, int>(7, 111));
...
TEST(s21_map_erase_check, test25) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(8, 111));
  t.insert(std::pair<int, int>(7, 111));
...
TEST(s21_map_erase_check, test26) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test27) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test28) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test29) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(6, 111));
...
TEST(s21_map_erase_check, test30) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(6, 111));
...
TEST(s21_map_erase_check, test31) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(6, 111));
...
TEST(s21_map_erase_check, test32) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test33) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test34) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test35) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test36) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test37) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
...
TEST(s21_map_erase_check, test38) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(9, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test39) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(9, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test40) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(9, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test41) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(9, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test42) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(9, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test43) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(9, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_erase_check, test44) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test45) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(2, 111));
  t.insert(std::pair<int, int>(3, 111));
...
TEST(s21_map_erase_check, test46) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  for (int i = -27; i < 36; ++i) {
    t.insert(std::pair<int, int>(i, 111));
...
TEST(s21_map_erase_check, test47) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(4, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_max_size_check, test1) {
  s21::Map<double, int> t;
...
TEST(s21_map_max_size_check, test2) {
  s21::Map<long long int, char> t;
  std::map<long long int, char> t_original;
  ASSERT_EQ(t.max_size(), t_original.max_size());
}

TEST(s21_map_max_size_check, test3) {
  s21::Map<std::string, char> t;
  std::map<std::string, char> t_original;
  ASSERT_EQ(t.max_size(), t_original.max_size());
}

TEST(s21_map_swap_check, test1) {
  s21::Map<int, int> t_1, t_2;
  ...
  s21::Map<int, int>::iterator it = t_1.begin();
...
TEST(s21_map_constr_move_check, test1) {
  s21::Map<int, int> t_1;
  ...
  s21::Map<int, int> t_2(std::move(t_1));
...
TEST(s21_map_oper_move_check, test1) {
  s21::Map<int, int> t_1;
  std::map<int, int> t_original_1;
  for (int i = -27; i < 36; ++i) {
    t_1.insert(std::pair<int, int>(i, 85));
...
TEST(s21_map_brackets_check, test1) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(1, 111));
  t_original.insert(std::pair<int, int>(1, 111));
...
TEST(s21_map_brackets_check, test2) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  ASSERT_EQ(t[1], t_original[1]);
  t[0] = 50;
...
TEST(s21_map_brackets_check, test3) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  t.insert(std::pair<int, int>(9, 111));
  t.insert(std::pair<int, int>(2, 111));
...
TEST(s21_map_merge_check, test1) {
  s21::Map<int, char> t_1(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
  std::map<int, char> t_original_1(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});

  s21::Map<int, char> t_2({{11, 'a'},
                           {12, 'b'},
                           {13, 'c'},
                           {14, 'd'},
                           {15, 'e'},
  ...
  s21::Map<int, char>::iterator it = t_1.begin();
...
TEST(s21_map_merge_check, test2) {
  s21::Map<int, int> t_1, t_2;
  std::map<int, int> t_original_1, t_original_2;
  for (int i = -27; i < 36; ++i) {
    t_1.insert(std::pair<int, int>(i, 85));
...
TEST(s21_map_insert_key_obj_check, test1) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  bool res, res_original;
  for (int i = -27; i < 136; i += 3) {
...
TEST(s21_map_assign_check, test1) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  bool res, res_original;
  for (int i = -5; i < 13; i++) {
...
TEST(s21_map_const_check, test1) {
  s21::Map<int, int> t;
  std::map<int, int> t_original;
  ...
  s21::Map<int, int>::ConstIterator it = t.begin();
...
TEST(s21_map_initializer_check, test0) {
  const s21::Map<int, char> t(
      {{1, 'a'}, {2, 'b'}, {3, 'c'}, {4, 'd'}, {5, 'e'}, {6, 'f'}, {7, 'g'}});
